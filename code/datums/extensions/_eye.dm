...
/datum/extension/eye/proc/look(var/mob/new_looker, var/list/eye_args)
	...
	GLOB.moved_event.register(holder, src, .proc/unlook)
	GLOB.moved_event.register(current_looker, src, .proc/unlook)

	GLOB.destroyed_event.register(current_looker, src, .proc/unlook)
	GLOB.destroyed_event.register(extension_eye, src, .unlook)

	if(isliving(current_looker))
		GLOB.stat_set_event.register(current_looker, src, .proc/unlook)
	GLOB.logged_out_event.register(current_looker, src, .proc/unlook)

	return TRUE

/datum/extension/eye/proc/unlook()

	GLOB.moved_event.unregister(/singleton/observ/moved, holder, src, /datum/extension/eye/proc/unlook)
	GLOB.moved_event.unregister(/singleton/observ/moved, current_looker, src, /datum/extension/eye/proc/unlook)

	GLOB.destroyed_event.unregister(/singleton/observ/destroyed, current_looker, src, /datum/extension/eye/proc/unlook)
	GLOB.destroyed_event.unregister(/singleton/observ/destroyed, extension_eye, src, /datum/extension/eye/proc/unlook)

	if(isliving(current_looker))
		GLOB.stat_set_event.unregister(/singleton/observ/stat_set, current_looker, src, /datum/extension/eye/proc/unlook)
	GLOB.logged_out_event.unregister(/singleton/observ/logged_out, current_looker, src, /datum/extension/eye/proc/unlook)
