#define CALIBER_REVOLVER_SMALL	".32"
#define CALIBER_REVOLVER 		".38"
#define CALIBER_REVOLVER_MEDIUM	".44"
...
#define CALIBER_RIFLE_TINY		".22"
#define CALIBER_RIFLE_SMALL		".223"
#define CALIBER_RIFLE			"5.56"
#define CALIBER_BIG_RIFLE		"7.62"
#define CALIBER_RIFLE_MILITARY  "7.62x51mmR"
