...
/obj/item/paper/invoice/attackby(obj/item/weapon/P as obj, mob/user as mob)
...
/obj/item/paper/invoice/import/attackby(obj/item/weapon/P as obj, mob/user as mob)
	if(istype(P, /obj/item/pen))
		return
	else if(istype(P, /obj/item/card/id))
...
/obj/item/paper/invoice/business/attackby(obj/item/weapon/P as obj, mob/user as mob)
	if(istype(P, /obj/item/pen))
		return
	else if(istype(P, /obj/item/card/id))
		if(paid) return 1
