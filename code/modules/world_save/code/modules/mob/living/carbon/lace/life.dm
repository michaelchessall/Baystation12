/mob/living/carbon/lace/handle_breathing()
	return

/mob/living/carbon/lace/handle_mutations_and_radiation()
	return 0
	// laces maybe dont worry about radiation?
	if (radiation)
		if (radiation > 100)
			radiation = 100
...
/mob/living/carbon/lace/handle_environment(datum/gas_mixture/environment)
	return
	if(!environment)
		return
...
/mob/living/carbon/lace/handle_chemicals_in_body()
	return
	chem_effects.Cut()
...
/mob/living/carbon/lace/handle_regular_status_updates()	//TODO: comment out the unused bits >_>
	updatehealth()
...
/mob/living/carbon/lace/handle_regular_hud_updates()
	update_sight()
	if (healths)
		if (stat != 2)
			switch(health)
