...
**/
/obj/item/weapon/stock_parts/circuitboard/shuttleengine
...
/obj/item/weapon/stock_parts/circuitboard/bridge_computer
	name = T_BOARD("bridge computer")
	build_path = /obj/machinery/computer/bridge_computer
	origin_tech = list(TECH_DATA = 4, TECH_ENGINEERING = 4)
	board_type = "computer"

/obj/item/weapon/stock_parts/circuitboard/docking_beacon
