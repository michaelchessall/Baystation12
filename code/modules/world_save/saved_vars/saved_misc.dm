...
SAVED_VAR(/datum/reagents, reagent_list)

SAVED_VAR(/datum/reagent, data)
SAVED_VAR(/datum/reagent, volume)
SAVED_VAR(/datum/reagent, reagent_state)
SAVED_VAR(/datum/reagent, holder)
SAVED_VAR(/datum/reagent, overdose)
