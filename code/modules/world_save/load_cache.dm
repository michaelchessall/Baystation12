...
SAVED_VAR(/datum/persistence/load_cache/z_level, height)
...
SAVED_VAR(/datum/persistence/load_cache/turf, y)
SAVED_VAR(/datum/persistence/load_cache/turf, z)
...
/datum/persistence/load_cache/turf
	var/x
	var/y
	var/z

/datum/persistence/load_cache/area
	var/name
	var/area_type
